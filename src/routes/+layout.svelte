				...
				<div class="lg:self-center flex items-center mb-4 lg:mb-0 hidden mr-3 lg:flex">
					<div class="items-center mr-3 flex">
						<a
							href="https://github.com/hannansatopay/devstar"
							target="_blank"
							class="hidden xl:inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1"
							><svg
								class="w-5 h-5"
								aria-hidden="true"
								focusable="false"
...
<footer class="p-4 bg-white shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 rounded-none">
	<span class="block text-sm text-gray-500 text-left sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <a href="https://craftlab.ai" target="_blank" class="hover:underline">Meta Craftlab</a> All Rights Reserved.</span>
