...
<<<<<<< HEAD
	'case-converter': {
		...
		link: '/case-converter',
		description:
			'The Case Converter is a versatile and user-friendly tool designed to streamline the manipulation of text cases for developers, content creators, and anyone dealing with text formatting. It provides a convenient way to convert text between different letter case styles, making it easy to modify and standardize the appearance of text in various contexts. Whether you need to convert text to uppercase, lowercase, sentence case, or other formats, this tool simplifies the process, saving you time and effort.'
	},
=======
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
>>>>>>> 577809cda2a10c57c069124d108249f1ab0a1ccc
	'unit-converter': {
		name: 'Unit Converter',
		icon: 'arrow-right-arrow-left',
		link: '/unit-converter',
