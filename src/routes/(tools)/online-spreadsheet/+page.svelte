	...
	function handleFileChange(event) {
  	...
  	function parseExcel(file) {
		...
		reader.onload = (e) => {
			...
			const firstSheet = workbook.Sheets[workbook.SheetNames[0]]; // First sheet in the workbook. (Sheet 1)
	...
	{:else if showUploadSection}
		<div class="flex justify-center item-center mt-4 ml-4 mr-4">
			<ButtonGroup>
				...
				<Button size="md" outline color="blue" class="mb-4" on:click={deleteRow}>Remove Row</Button>
				<Button size="md" outline color="blue" class="mb-4" on:click={deleteColumn}>Remove Column</Button>
	...
	{:else if showCreateSection}
		...
		<div class="flex justify-center item-center mt-4 ml-4 mr-4">
			<ButtonGroup>
				...
				<Button size="md" outline color="blue" class="mb-4" on:click={deleteRow}>Remove Row</Button>
				<Button size="md" outline color="blue" class="mb-4" on:click={deleteColumn}>Remove Column</Button>
				<GradientButton size="md" color="blue" class="mb-4" on:click={() => {showCreateSection = false; rowData = []; numRows=8; numCols=13;}}>Back</GradientButton>
			</ButtonGroup>
		</div>	
