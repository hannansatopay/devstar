...
<section class="py-2">
  ...
  >
    <div class="p-8 col-span-2 w-full flex justify-center">
      <label
        for="dropzone-file"
        class="mx-auto cursor-pointer flex w-full flex-col items-center rounded-xl border-2 border-dashed border-blue-400 bg-white p-6 text-center"
      >
        <svg
    ...
    <div class="p-8">
      ...
      {#if watermarkType === "text"}
        <div class="mt-8 flex justify-center">
          ...
          <Input
            ...
            class="ml-2 p-2 border border-gray-300 rounded-md w-60"
          />
        </div>
      ...
      <div class="flex justify-center mt-6">
        <button
          type="button"
          class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-3 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
