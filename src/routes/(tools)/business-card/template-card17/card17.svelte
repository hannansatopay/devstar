<div class="back17" id="backContainer">
    <section class="frame5">
      <div class="john-leopard-real-estate-agent-parent">
        <div class="john-leopard-real-container">
          <p class="john-leopard">John Leopard</p>
          <p class="real-estate-agent">Real Estate Agent</p>
        </div>
        <img class="frame-icon" alt="" src="./public/9-1@2x.png" />
      </div>
      <img class="icon2" alt="" src="./public/8-1@2x.png" />


      <div class="frame-child"></div>
      <div class="frame6">
        <div class="div">+91 12345 67890</div>
        <div class="div">20010997@ycce.in</div>
        <div class="div">Nagpur,Maharashtra,India</div>
      </div>
      <div class="frame7">
        <img class="frame-icon1" alt="" src="./public/frame@2x.png" />


        <img class="frame-icon2" alt="" src="./public/frame1@2x.png" />


        <img class="frame-icon3" alt="" src="./public/frame2@2x.png" />
      </div>
    </section>
  </div>
...
<head>
  ...
  <style>
    ...
    .icon2,
    .john-leopard-real-estate-agent-parent {
      position: absolute;
      top: 0;
      left: 0;
      width: 300px;
...
<body>
  <div class="front17" id="frontContainer">
    <section class="frame">
      <img class="icon" alt="" src="./public/9-1@2x.png" />
    </section>
    <div class="frame1">
      <div class="frame2">
        <div class="frame3">
        ...
        <div class="frame4">
          <div class="fauget-real-estate-container">
            ...
            <p class="real-estate">Real Estate</p>
          </div>
        </div>
      </div>
    </div>
