...
<div class="main-container mb-4 flex justify-center items-center flex-col lg:flex-row py-4 px-12 border-2 rounded-lg shadow-sm shadow-blue-300">

  <!-- Input fields to capture user input for each data item -->

  <div class="min-w-full lg:min-w-0 bg-transparent lg:w-1/3">
    <Button class="mb-4 w-3/4  bg-gray-600 hover:bg-gray-700 focus:ring-gray-400">Select Chart Type<ChevronDownSolid class="w-3 h-3 ml-2 text-white dark:text-white" /></Button>
    <Dropdown>
	...
	<div style="display: none;" id="last_data_added" class="py-2" >
		<p class="text-sm font-bold py-2 dark:text-white">Added Data <span class="px-2 py-1 text-green-700 bg-green-200 rounded-md" id="Xaxis_value"></span> <span class="py-1 px-2 text-green-700 bg-green-200 rounded-md" id="Yaxis_value"></span></p>
	</div>
  </div>

  <div class="chart_container lg:w-1/3">
    <div id="chartdiv" bind:this={chartdiv} style="width: {chartWidth}; height: 400px; background-color: rgb(243, 243, 243); border-radius: 10px;"></div>
  </div>
</div>
