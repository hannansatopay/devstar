<script>
  ...
  const handleJoinClick = () => {
    // Log the input (name) when the button is pressed
    ...
    <Card class="p-10 md:min-w-[600px] md:min-h-[400px]">
      ...
      <div class="flex flex-col items-center pb-4">
        ...
        <div class="flex justify-center mt-4 w-full lg:mt-6">
          <Button class="w-full md:w-96" on:click={handleJoinClick}>Join</Button
          >
          <!-- <a href="/online-live-quiz/enter">asdsad</a> -->
        </div>
      </div>
    </Card>
  </div>
