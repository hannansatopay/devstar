        ...
        for (let section of $sections) {
            ...
            if (section.type === "header" || section.type === "paragraph") {
                ...
                if (section.type === "header") {
                    const textWidth =
                        (doc.getStringUnitWidth(section.content) *
                            section.size) /
                ...
                try {
                    ...
                    const imageHeight =
                        (dimensions.height * imageWidth) / dimensions.width;
        ...
        {#each $sections as section, index}
            <div class="section">
                ...
                <input
                    ...
                    min="1"
                    max="72"
                    bind:value={section.size}
                    on:input={(e) =>
                        updateSection(index, "size", e.target.value)}
                />

                <label>Font Family:</label>
                <select
                    bind:value={section.fontFamily}
                    on:change={(e) =>
                        updateSection(index, "fontFamily", e.target.value)}
                >
                ...
                {#if section.type === "header"}
                    ...
                    <input
                        ...
                        type="color"
                        bind:value={section.highlightColor}
                        on:input={(e) =>
                            updateSection(
                                index,
                                "highlightColor",
                ...
                <input
                    class="boldCheck"
                    type="checkbox"
                    bind:checked={section.bold}
                    on:change={(e) =>
                        updateSection(index, "bold", e.target.checked)}
                />

                <label>Alignment:</label>
                <select
                    bind:value={section.alignment}
                    on:change={(e) =>
                        updateSection(index, "alignment", e.target.value)}
                >
                ...
                <div class="section-actions">
                    <button on:click={() => removeSection(index)}
